    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <nav className="hidden lg:flex items-center gap-5 text-sm font-medium text-gray-600">
          <a href="https://www.reparacionessimplesdelhogar.com.ar" className="hover:text-[#f97316] transition-colors">Inicio</a>
          <Link href="/blog" className="text-[#f97316] transition-colors">Blog</Link>
          <a href="https://www.reparacionessimplesdelhogar.com.ar/herramientas" className="hover:text-[#f97316] transition-colors">Herramientas</a>
          <a href="https://www.reparacionessimplesdelhogar.com.ar/ebook" className="hover:text-[#f97316] transition-colors">Ebook</a>
          <a href="https://www.reparacionessimplesdelhogar.com.ar/contacto" className="hover:text-[#f97316] transition-colors">Contacto</a>
          <a href="https://www.reparacionessimplesdelhogar.com.ar/planes" className="hover:text-[#f97316] transition-colors">Planes para Profesionales</a>
        </nav>
